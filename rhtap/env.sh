...
export IMAGE_URL=${IMAGE_URL-artifactory-docker-artifactory-jcr.apps.rosa.rhtap-services.xmdt.p3.openshiftapps.com/rhtap/rhtap-qe-nodejs:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/sjm-rhtap/oqp89daf2-nodejs-gitops
